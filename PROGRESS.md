...
### Infrastructure ✅
- TypeScript project with esbuild bundler
- `bash build.sh` typechecks + bundles to single JSX in ~50ms
...
- Gold formatting is inlined in index.tsx instead of using fmt()
