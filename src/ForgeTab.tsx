                ...
                <div key={faceIdx} style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: atFloor ? "#0a0a14" : "#12121e",
                      border: atFloor ? "1px solid #181828" : "1px solid #2a2a40",
                      color: atFloor ? "#333" : "#99aabb",
                      fontSize: 18, fontWeight: 700, fontFamily: "monospace",
                      cursor: atFloor ? "default" : "pointer",
