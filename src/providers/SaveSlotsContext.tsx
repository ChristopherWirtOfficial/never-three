...
export type SaveSlotsContextValue = {
	...
	duplicateProfile: (sourceId: string, optionalDisplayName?: string) => Promise<void>
...
export function SaveSlotsProvider({
	...
	children: ReactNode
	value: Omit<SaveSlotsContextValue, 'saveManagerOpen' | 'openSaveManager' | 'closeSaveManager'>
}) {
	...
	return <SaveSlotsContext.Provider value={merged}>{children}</SaveSlotsContext.Provider>
}
