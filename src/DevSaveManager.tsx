...
import { listProfiles, createProfile, deleteProfile, renameProfile, boot, loadProfile, setActiveProfileId, type SaveState } from "./saves";
...
export function DevSaveManager({
  visible, onClose, currentProfileId, currentProfileName,
  onLoadProfile, onNewProfile,
}: DevSaveManagerProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: "#0c0c1a", border: "1px solid #2a2a40",
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 700, color: "#ffdd33", letterSpacing: 1 }}>
            🛠 DEV SAVES
          </div>
          ...
          {profiles.map(p => {
            ...
            return (
              <div key={p.id} style={{
                ...
                border: isActive ? "1px solid #44ffbb44" : "1px solid #1a1a2e",
                borderRadius: 10,
              }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                  {isEditing ? (
                    <input
                      ...
                      autoFocus
                      style={{
                        flex: 1, background: "#1a1a30", border: "1px solid #44ffbb44",
                        borderRadius: 6, padding: "4px 8px", color: "#ddd",
                  ...
                  {isActive && (
                    <span style={{
                      fontSize: 9, color: "#44ffbb", padding: "2px 6px",
                      background: "#44ffbb15", borderRadius: 4, letterSpacing: 1,
                    }}>
                      ACTIVE
                    </span>
                  )}
                ...
                <div style={{ display: "flex", gap: 6 }}>
                  {!isActive && (
                    <button onClick={() => handleLoad(p.id)} style={{
                      ...
                      background: "#1a2a22", border: "1px solid #44ffbb33",
                      color: "#44ffbb", fontFamily: "monospace", fontSize: 11,
                  ...
                  <button onClick={() => {
                    ...
                    color: "#99aabb", fontFamily: "monospace", fontSize: 11,
                    fontWeight: 700, cursor: "pointer",
                  }}>
                    RENAME
                  </button>
                  <button onClick={() => handleDelete(p.id)} style={{
                    ...
                    border: isConfirming ? "1px solid #ff335566" : "1px solid #333",
        ...
        {/* Create new */}
        <div style={{
          padding: "12px 12px 14px", borderTop: "1px solid #1a1a2e",
          display: "flex", gap: 8,
        }}>
          <input
            value={newName}
            ...
            style={{
              flex: 1, background: "#0e0e1c", border: "1px solid #2a2a40",
              borderRadius: 8, padding: "8px 10px", color: "#bbc",
          ...
          <button onClick={handleCreate} style={{
            ...
            color: "#44ffbb", fontFamily: "monospace", fontSize: 12,
