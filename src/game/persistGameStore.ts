...
export const durableGameAtoms = [
  P.goldAtom,
  P.lifetimeGoldEarnedAtom,
  P.goldStreakAtom,
  P.bestGoldStreakAtom,
  P.hexBalanceAtom,
...
export function collectSaveStateFromStore(store: Store): SaveState {
  return {
    ...
    lifetimeGoldEarned: store.get(P.lifetimeGoldEarnedAtom),
    goldStreak: store.get(P.goldStreakAtom),
    bestGoldStreak: store.get(P.bestGoldStreakAtom),
...
export function hydrateStoreFromSaveState(
  ...
  store.set(P.lifetimeGoldEarnedAtom, state.lifetimeGoldEarned);
  store.set(P.goldStreakAtom, state.goldStreak);
  store.set(P.bestGoldStreakAtom, state.bestGoldStreak);
  ...
  store.set(
    P.streakRetentionUpgradeLevelAtom,
    state.streakRetentionUpgradeLevel,
  );
